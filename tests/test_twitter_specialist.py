...
def test_twitter_specialist():
    ...
    specialist = TwitterSpecialist(MockLLMProvider())
    ...
    assert result.output_type == "twitter"
    assert result.content
    assert result.metadata["specialist"] == "TwitterSpecialist"