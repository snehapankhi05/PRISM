...
def test_executive_summary_specialist():
    ...
    controls = GenerationControls(
        ...
        communication_objective="Inform decision-makers",
        content_style="Executive",
    )

    specialist = ExecutiveSummarySpecialist(MockLLMProvider())
    ...
    assert result.output_type == "executive_summary"
    assert result.content
    assert result.metadata["specialist"] == "ExecutiveSummarySpecialist"